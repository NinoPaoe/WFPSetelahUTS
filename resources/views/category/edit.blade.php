...
<div class="container">
  ...
  <form method="POST" action="{{url('kategori_obat/'.$category->id)}}">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="4" id="description" name="description" placeholder="Description">{{$category->description}}</textarea>
    </div>
  </div>
  <!-- /.card-body -->
